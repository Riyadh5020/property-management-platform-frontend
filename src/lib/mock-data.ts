...
export const resources: Record<string, ResourceDef> = {
  ...
  units: def(
    ...
    "Units",
    "Unit",
    "Floor and unit setup with size, type, furnishing and live status.",
    [
      { key: "code", label: "Unit code", inTable: true },
      { key: "building", label: "Building", type: "select", options: BUILDINGS, inTable: true },
      { key: "floor", label: "Floor", type: "number", inTable: true },
      {
        key: "type",
        label: "Unit type",
        type: "select",
        options: ["Apartment", "Office", "Shop"],
        inTable: true,
      },
      { key: "size", label: "Size (sq ft)", type: "number", inTable: true },
      {
        key: "furnishing",
        label: "Furnishing",
        type: "select",
  ...
  tenants: def(
    ...
    [
      ...
      { key: "unit", label: "Unit", inTable: true },
      {
        ...
        label: "ID document",
        type: "select",
        options: ["NID", "Passport", "Driving licence"],
        inTable: true,
      },
      ...
      { key: "moveOut", label: "Move-out date", type: "date" },
      {
        ...
        label: "Tenancy role",
        type: "select",
        options: ["Primary tenant", "Co-tenant"],
        inTable: true,
      },
      {
        key: "status",
        label: "Status",
        type: "select",
        options: ["Active", "Notice served", "Moved out"],
        inTable: true,
        badge: true,
      },
    ],
    [
      ...
      {
        name: "Bright Logic Ltd.",
        phone: "+8801555667788",
        email: "ops@brightlogic.io",
        unit: "ST-12C",
        docType: "NID",
        docNumber: "1985222333444",
        moveIn: "2023-08-15",
        moveOut: "",
        role: "Primary tenant",
        status: "Active",
  ...
  leases: def(
    ...
    [
      ...
      { key: "noticePeriod", label: "Notice period (days)", type: "number" },
      {
        ...
        type: "select",
        options: ["Draft", "Sent for signature", "Signed"],
        inTable: true,
        badge: true,
      },
    ],
    [
      ...
      {
        reference: "AGR-2023-044",
        tenant: "Bright Logic Ltd.",
        unit: "ST-12C",
      ...
      {
        reference: "AGR-2026-002",
        tenant: "Rafiq Enterprise",
        unit: "ST-G2",
  ...
  maintenance: def(
    ...
    [
      ...
      { key: "unit", label: "Unit / area", inTable: true },
      {
        ...
        label: "Category",
        type: "select",
        options: ["Tenant request", "Preventive", "Common area"],
        inTable: true,
      },
      {
        key: "priority",
    ...
    [
      {
        ...
        priority: "High",
        assignee: "Jamal (plumber)",
        scheduledFor: "2026-08-12",
        cost: 3500,
        status: "In progress",
        notes: "Tenant reported dripping from ceiling pipe.",
      },
      {
        ...
        category: "Preventive",
        priority: "Medium",
        assignee: "PowerCare Ltd.",
        scheduledFor: "2026-08-20",
        cost: 18000,
        status: "Open",
        notes: "Quarterly service contract.",
      },
      {
        title: "Lobby repainting",
        building: "Riverside Court",
        unit: "Lobby",
      ...
      {
        title: "Lift emergency alarm fault",
        building: "Uttara Business Park",
        unit: "Lift 2",
        category: "Preventive",
        priority: "Urgent",
        assignee: "OTIS service",
  ...
  visitors: def(
    ...
    [
      ...
      { key: "unit", label: "Visiting unit", inTable: true },
      {
        ...
        label: "Purpose",
        type: "select",
        options: ["Guest", "Delivery", "Contractor", "Incident"],
        inTable: true,
      },
      ...
      { key: "guard", label: "Guard on duty", inTable: true },
      {
        ...
        label: "Status",
        type: "select",
        options: ["Inside", "Checked out", "Denied"],
        inTable: true,
        badge: true,
      },
    ...
    [
      {
        ...
        unit: "EH-4B",
        purpose: "Guest",
        entryTime: "2026-08-11 14:20",
        exitTime: "",
        guard: "Shahin (Shift A)",
        status: "Inside",
        notes: "",
      },
      {
        ...
        unit: "ST-12C",
        purpose: "Delivery",
        entryTime: "2026-08-11 11:05",
        exitTime: "2026-08-11 11:18",
        guard: "Bashir (Shift A)",
        status: "Checked out",
        notes: "Parcel handed to reception.",
      },
      {
        ...
        unit: "Gate",
        purpose: "Incident",
        entryTime: "2026-08-09 22:40",
        exitTime: "2026-08-09 22:45",
        guard: "Rubel (Shift C)",
        status: "Denied",
        notes: "Attempted entry without pass; police notified.",
      },
    ],
  ),
  ...
  staff: def(
    ...
    [
      { key: "name", label: "Name", inTable: true },
      {
        ...
        label: "Role",
        type: "select",
        options: ["Guard", "Cleaner", "Electrician", "Plumber", "Manager"],
        inTable: true,
      },
      { key: "building", label: "Building", type: "select", options: BUILDINGS, inTable: true },
      {
      ...
      { key: "attendance", label: "Attendance this month (days)", type: "number", inTable: true },
      {
        ...
        label: "Status",
        type: "select",
        options: ["On duty", "Off duty", "On leave"],
        inTable: true,
        badge: true,
      },
    ],
  ...
  utilities: def(
    ...
    [
      ...
      { key: "building", label: "Building", type: "select", options: BUILDINGS, inTable: true },
      {
        ...
        label: "Utility",
        type: "select",
        options: ["Electricity", "Gas", "Water", "Service charge"],
        inTable: true,
      },
  ...
  owners: def(
    ...
    [
      ...
      { key: "dues", label: "Outstanding dues", type: "money", inTable: true },
      {
        ...
        label: "Payout status",
        type: "select",
        options: ["Settled", "Pending", "On hold"],
        inTable: true,
        badge: true,
      },
    ],
    [
      ...
      },
      {
        ...
        share: 100,
        phone: "+8801700000003",
        email: "invest@deltaholdings.com",
        payout: 70200,
        dues: 0,
        status: "On hold",
      },
